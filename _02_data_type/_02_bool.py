...
# and 연산
# - A가 참이고 B도 참인 경우에 True (나머지는 모두 False)
# T and T == T -> 얘만 중요!
# T and F == F
# F and T == F
# F and F == F
...
print('--- and ---')
print(100 > 0 and 1 == 1) # True -> T and T
...
# input() 함수 : 키보드 입력을 받는 함수 (str이 기본 설정값)
# int() 함수 : str -> int로 변환
...
# 합격이야 언제? 만약 result가 True 면, True가 아니면 '불합격'
