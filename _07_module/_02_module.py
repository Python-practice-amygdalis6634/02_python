...
- 단, _, __ 이 두가지로 시작하는 이름은 '내부용(private)'이라는 관례가 있음.
    -> 외부에서 import해서 사용하는 것을 지양함
- import * -> 묘듈 내 모든 변수, 함수, 클래스, 가져오기
...
# 현재 모듈을 import해서 실행할때 하위 코드를 실행하지 마라
